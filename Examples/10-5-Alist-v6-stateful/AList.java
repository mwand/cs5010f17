...
// *** NOTICE THAT ALL THESE EQUALITIES ARE OF VALUES AND BOOLEANS,
// *** NOT OF ALISTS THEMSELVES.  THEY TALK ABOUT THE **BEHAVIOR** OF
// *** ALISTS. 
...
interface AList<K extends Comparable<K>,V> {

    // extends this AList by associating the given key with the given value.

    void extend (K key, V val);
